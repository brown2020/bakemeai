 ...
 * 
 * USAGE: Emergency fallbacks only when structured data is incomplete.
 * The AI generation flow always provides structured data. These functions
 * exist for defensive programming and backwards compatibility with old recipes.
 * 
 * DO NOT USE these functions for new features. Always use structured data.
 */

/**
 * Extracts the title from markdown content.
 * @deprecated Use structured data instead
 */
