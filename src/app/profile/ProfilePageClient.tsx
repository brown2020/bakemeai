...
export function ProfilePageClient({ isWelcomeFlow }: { isWelcomeFlow: boolean }) {
      ...
      <div className="max-w-2xl space-y-4">
        ...
        <div className="bg-white rounded-lg shadow-xs p-4 sm:p-6 border border-surface-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <TagInput
              key={`allergies-${profile.allergies.join("|")}`}
              label="Allergies"
            ...
            <TagInput
              key={`disliked-${profile.dislikedIngredients.join("|")}`}
