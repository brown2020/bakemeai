...
Current coverage is **pure-function unit tests only** (9 suites, 42 tests), colocated next to their source:
`jwt`, `route-match`, `navigation`, `onboarding`, `recipe-prompt`, `recipe-servings`, `nutrition`, `print-recipe`, `recipe-copy`.
