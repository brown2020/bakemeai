...
Current coverage is **pure-function unit tests only** (8 suites, 34 tests), colocated next to their source:
`jwt`, `route-match`, `onboarding`, `recipe-prompt`, `recipe-servings`, `nutrition`, `print-recipe`, `recipe-copy`.
